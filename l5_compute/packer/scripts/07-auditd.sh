...
-a always,exit -F arch=b32 -S chmod,chown,fchmod,fchown,lchown -F auid>=1000 -F auid!=4294967295 -k perm_mod
...
-a always,exit -F arch=b32 -S init_module,finit_module,delete_module -F auid>=1000 -F auid!=4294967295 -k modules
