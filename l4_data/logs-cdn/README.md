# l4_data/logs-cdn opentofu

We need a bucket to store CDN logs.

It should not require versioning, so that was left out.
Eventually some lifecycle rules will be needed.
...
| Name | Type |
|------|------|
| [digitalocean_spaces_bucket.logs_cdn_bucket](https://registry.terraform.io/providers/digitalocean/digitalocean/latest/docs/resources/spaces_bucket) | resource |
